...
kid_length_plot <- national_parks %>%
  ...
  scale_fill_cyclical(
    ...
    values = c("darkorange3", "dodgerblue1", "darkorange3", "dodgerblue1"),
    name = "Option", guide = "legend"
  ) +
  labs(x= "", y="", title = "Trail length (miles) for <strong><span style='color:dodgerblue3'>kid</span></strong></b> versus <strong><span style='color:darkorange3'>not kid</span></strong></b> recommended trails")+
  theme_minimal()+
...
```{r}
layout <- c(
  area(t = 2, l = 0, b = 15, r = 3), 
  area(t = 16, l = 0, b = 29, r = 3)
)
kid_length_plot + kid_prop_plot + 
  plot_layout(design = layout)
```

Recommend 2 trails at each national park:
```{r}
c("Great Smoky Mountains National Park", "Yellowstone National Park", "Zion National Park", "Rocky Mountain National Park", "Grand Teton National Park", "Grand Canyon National Park", "Cuyahoga Valley National Park", "Acadia National Park", "Olympic National Park", "Joshua Tree National Park")

rec_parks <- national_parks %>%
  filter(kids == 1, area_name == "Yellowstone National Park") %>%
  arrange(desc(avg_rating, total_features))
```
